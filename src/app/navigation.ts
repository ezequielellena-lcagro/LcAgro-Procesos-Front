...
export const NAV: Area[] = [
  ...
  },
  {
    ...
    procesos: [
      ...
      {
        kind: "activo",
        label: "Posición de Producción Propia",
        title: "Posición de Producción Propia",
        to: "/produccion-propia",
        roles: ["produccionpropia"],
      },
      {
        kind: "activo",
        label: "Volumen Acopiado por Vendedor",
        title: "Volumen Acopiado por Vendedor",
        to: "/volumen-acopiado",
        roles: ["volumenacopiado"],
      },
  ...
  },
  {
    ...
    procesos: [
      ...
      { kind: "futuro", label: "Planificación de Ventas" },
