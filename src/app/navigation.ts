...
export const NAV: Area[] = [
    ...
    procesos: [
      {
        ...
        to: "/cuentas",
        roles: ["Admin", "Cobranzas", "SoloLectura"],
      },
  ...
  },
  {
    ...
    area: "Administración",
    procesos: [
      { kind: "activo", label: "Configuración", title: "Configuración", to: "/config", roles: ["Admin"] },
      { kind: "activo", label: "Usuarios", title: "Usuarios", to: "/usuarios", roles: ["Admin"] },
      { kind: "activo", label: "Auditoría", title: "Auditoría", to: "/auditoria", roles: ["Admin"] },
    ],
  },
];
