...
const ROLES = ["Admin", "Operador", "Cobranzas", "SoloLectura"];

let seq = 4;
const USUARIOS: UsuarioDto[] = [
  { id: 1, nombre: "Admin Demo", email: "admin@lcagro.local", activo: true, roles: ["Admin"], fechaAlta: "2026-01-15T10:00:00Z" },
  { id: 2, nombre: "Operador Acopio", email: "operador@lcagro.local", activo: true, roles: ["Operador"], fechaAlta: "2026-02-03T09:30:00Z" },
  { id: 3, nombre: "Cobranzas Demo", email: "cobranzas@lcagro.local", activo: true, roles: ["Cobranzas"], fechaAlta: "2026-02-20T14:10:00Z" },
  { id: 4, nombre: "Solo Lectura", email: "lectura@lcagro.local", activo: true, roles: ["SoloLectura"], fechaAlta: "2026-03-01T08:00:00Z" },
];
