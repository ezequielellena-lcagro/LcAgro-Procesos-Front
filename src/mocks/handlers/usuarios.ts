...
const ROLES = ["dashboard", "posicion", "cuentas", "proveedores", "semilla", "stock", "planificacion-vendedores", "usuarios", "config", "auditoria"];

let seq = 4;
const USUARIOS: UsuarioDto[] = [
  { id: 1, nombre: "Admin Demo", email: "admin@lcagro.local", activo: true, roles: ["dashboard", "posicion", "cuentas", "proveedores", "semilla", "stock", "planificacion-vendedores", "usuarios", "config", "auditoria"], fechaAlta: "2026-01-15T10:00:00Z" },
