...
const AUDIT: AuditDto[] = [
  ...
  { id: 6, usuarioId: 1, accion: "Create", entidad: "Usuario", entidadId: "5", datos: '{"email":"nuevo@lcagro.local","roles":["Operador"]}', ip: "192.168.100.110", fecha: "2026-06-19T11:05:00Z" },
  ...
  { id: 1, usuarioId: 1, accion: "Update", entidad: "Usuario", entidadId: "3", datos: '{"activo":true,"roles":["Cobranzas"]}', ip: "192.168.100.110", fecha: "2026-06-14T13:20:00Z" },
];
