...
export const prestamosHandlers = [
  ...
  // El .xlsx del modo mocks va vacío: generar un Excel real en el browser no aporta nada (el
  // formato lo cubren los tests del backend) y sí pesaría en el bundle.
