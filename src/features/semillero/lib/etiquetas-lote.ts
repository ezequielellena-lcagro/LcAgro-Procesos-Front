...
/** "Propio" o "Cliente · {denominación}": el mismo texto en Stock, Movimientos y el armado de la orden. */
export function duenioEtiqueta(f: { duenio: DuenioLote; clienteDenominacion: string | null }): string {
 ...
 */
export function productoEtiqueta(f: { variedad: string; tratada: boolean; envase: EnvaseSemillero }): string {
