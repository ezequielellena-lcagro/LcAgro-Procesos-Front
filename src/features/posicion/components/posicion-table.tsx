...
const columns: Column<PosicionDto>[] = [
  ...
  { key: "tnCalzadas", header: "Calzadas", align: "right", className: "whitespace-nowrap", cell: (r) => numero(r.tnCalzadas) },
  { key: "margenUsdTn", header: "Margen US$/tn", align: "right", className: "whitespace-nowrap", cell: (r) => oDash(r.margenUsdTn, usd) },
  { key: "margenPct", header: "Margen %", align: "right", className: "whitespace-nowrap", cell: (r) => oDash(r.margenPct, pct) },
  { key: "resultadoUsd", header: "Resultado US$", align: "right", className: "whitespace-nowrap", cell: (r) => usd(r.resultadoUsd) },
  {
    key: "posicionFinal",
    header: "Posición tn",
    align: "right",
