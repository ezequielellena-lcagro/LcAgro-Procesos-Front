...
const tresDecimalesFmt = new Intl.NumberFormat("es-AR", { minimumFractionDigits: 3, maximumFractionDigits: 3 });
...
export const numero3 = (n: number) => tresDecimalesFmt.format(n);
